import { FaFutbol, FaCamera, FaCube, FaBook, FaPen } from "react-icons/fa"
  ...
  const interests = [
    {
      ...
      icon: <FaFutbol />,
      description:
        "Play a variety of sports and aim to try as many as possible. Football is my favorite, along with basketball, volleyball, tchoukball, ping pong, golf, and pickleball.",
    },
    {
      title: "Photography",
      icon: <FaCamera />,
      description:
        "Capture moments and explore creative perspectives through visual storytelling.",
    },
    {
      title: "3D Modeling and Animation",
      icon: <FaCube />,
      description:
        "Create 3D designs using Blender and explore creativity in digital environments.",
    },
    {
      title: "Reading",
      icon: <FaBook />,
      description:
        "Read a wide range of books to explore new ideas and perspectives.",
    },
    {
      title: "Journaling",
      icon: <FaPen />,
      description:
        "Write down goals and reflections, tracking progress and setting short- and long-term objectives.",
    },
  ]
    ...
    <section id="interests" className="py-20 px-8 bg-slate-50">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-slate-500 text-center max-w-2xl mx-auto mb-12">
          Beyond technology, I enjoy activities that challenge creativity,
