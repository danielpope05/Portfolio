export default function Skills() {
  const skillGroups = [
    ...
    },
    {
      ...
      skills: [
        "Microsoft Office (Word, Excel, PowerPoint, Outlook, OneNote, Access, SharePoint, Teams)",
    ...
    <section id="skills" className="py-20 px-8 bg-slate-950">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-slate-400 text-center max-w-2xl mx-auto mb-12">
          A growing toolkit across software development, cybersecurity,
...
//     {
//   title: "Programming",
//   skills: ["Python", "Java", "C/C++", "C#", "JavaScript", "PHP", "SQL", "R", "VBA", "Haskell"],
//     },
//     {
//       title: "Frontend",
//       skills: ["React", "JSX", "HTML", "CSS", "Tailwind CSS"],
