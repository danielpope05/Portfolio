export default function LeadershipExperience() {
  ...
  return (
    <section id="leadership" className="py-20 px-8 bg-slate-950">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-slate-400 text-center max-w-2xl mx-auto mb-12">
          Leadership, mentorship, community engagement, and volunteer experience developed through university organizations and community initiatives.
        </p>
